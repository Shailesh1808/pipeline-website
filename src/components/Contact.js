...
const Contact = () => {
  ...
  const contacts = [
    {
      icon: <FaMedium className="text-5xl mb-4 text-white" />,
      title: "@PipelineAI_25",
      description: "Follow our weekly Blogs on Medium",
      link: "https://medium.com/@PipelineAI_25",
    },
    {
      icon: <FaInstagram className="text-5xl mb-4 text-white" />,
      title: "@pipelineai_25",
    ...
    {
      icon: <FaXTwitter className="text-5xl mb-4 text-white" />,
      title: "@PipelineAI25",
      description: "Follow us on X to keep up with Cybersecurity news",
      link: "https://x.com/PipelineAI25",
    },
    {
      icon: <MdEmail className="text-5xl mb-4 text-white" />,
  ...
  return (
    <section
      id="contact"
      className=" text-white pt-10 pb-20 px-6 md:px-20 scroll-mt-24 bg-robot-arm bg-lock-left"
    >
      <h2 className="text-4xl md:text-5xl font-bold text-center mb-12 text-[#FFFDD0]">
